# ClientesApp
ClientesApp é uma API desenvolvida em .NET 8 para gerenciamento de clientes. A aplicação utiliza **SqlClient**,
 **Dapper** para acesso ao banco de dados, **DTOs** para troca de dados, **Repositories** para abstração de acesso,
